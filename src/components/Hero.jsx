           ...
           <div>
              <div className="mask-clip-path absolute-center  absolute z-50 size-64 
                  cursor-pointer overflow-hidden rounded-lg ">
                    <div onClick={handleMiniVdClick} className='origin-center scale-150 opacity-0
            ...
            <video 
                     ref={nextVideoRef}
                      ...
                      autoPlay
                      id='next-video'
                      className="absolute-center invisible absolute z-20  size-6
                         object-cover object-center
                         "
                         onLoadedData={handleVideoLoad}
                     />
                     ...
                     src={getVideoSrc(
                      ...
                      className="  absolute   left-0 to-0 size-full
                         object-cover object-center
                         "
                         onLoadedData={handleVideoLoad}
                     />
           ...
           <h1 className="special-font hero-heading absolute
             ...
             <div className="absolute left-0 top-0 z-40 size-full ">
                <div className='mt-24 px-5 sm:px-10'>
                    <h1 className="
                    special-font hero-heading text-blue-100">
                        redefi<b>n</b>e</h1>
